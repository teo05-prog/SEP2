...
class AuthenticationServiceImplTest
{
  ...
  {
    LoginDTO request = new LoginDTO("nonexistent@example.com", "password123");
  ...
  {
    LoginDTO request = new LoginDTO("test@example.com", "wrongpassword");
    User mockUser = new User("Test User", "password123", "test@example.com");
    when(mockUserDAO.readByEmail("test@example.com")).thenReturn(mockUser);
  ...
  @Test void register_successful() throws Exception
  {
    ...
    RegisterDTO request = new RegisterDTO("New User", "new@example.com", "password123", birthDate);
    ...
    ArgumentCaptor<RegisterDTO> registerRequestCaptor = ArgumentCaptor.forClass(RegisterDTO.class);
    ...
    RegisterDTO capturedRequest = registerRequestCaptor.getValue();
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("", "new@example.com", "password123", birthDate);

    String result = authenticationService.register(request);

    assertEquals("Name cannot be empty", result);
    verify(mockUserDAO, never()).readByEmail(anyString());
    verify(mockUserService, never()).createTraveller(any(RegisterDTO.class));
  }

  @Test void register_nameCannotBeNull() throws Exception
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO(null, "new@example.com", "password123", birthDate);
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("New User", "invalidemail", "password123", birthDate);
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("New User", "", "password123", birthDate);
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("New User", null, "password123", birthDate);
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("New User", "new@example.com", "pass", birthDate);
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("New User", "new@example.com", null, birthDate);
  ...
  {
    MyDate birthDate = new MyDate(1, 1, 2000, 0, 0);
    RegisterDTO request = new RegisterDTO("New User", "existing@example.com", "password123", birthDate);
  ...
  @Test void register_userServiceThrowsException() throws Exception
  {
    ...
    RegisterDTO request = new RegisterDTO("New User", "new@example.com", "password123", birthDate);
    when(mockUserDAO.readByEmail("new@example.com")).thenReturn(null);
    doThrow(new RuntimeException("DB error")).when(mockUserService).createTraveller(any(RegisterDTO.class));
    ...
    verify(mockUserDAO, times(1)).readByEmail("new@example.com");
    verify(mockUserService, times(1)).createTraveller(any(RegisterDTO.class));
  }
}